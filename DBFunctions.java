...
public class DBFunctions {
    ...
    public boolean insert_user(Connection conn, String table_name, String user_name, String user_password,
        ...
        Statement statement;
        try {
            String query = String.format("insert into %s(user_name, user_password, user_score) values('%s','%s',%s);",
                    table_name, user_name, user_password, user_score);
    ...
    public void Update_Score(Connection conn, String table_name, String User_name, int Score) {
        Statement statement;
        try {
            String query = String.format("update %s set user_score='%s' where user_name='%s'", table_name, Score,
                    User_name);
            statement = conn.createStatement();
            statement.executeUpdate(query);
